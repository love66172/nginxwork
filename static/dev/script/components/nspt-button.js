        ...
        memoryDropdown:'<div class="pt-btn-dropdown pt-btn-dropdown-senior pt-btn">'
                            ...
                            +'<div class="pt-btn-dropdown-panel hide">'
                                +'<div class="pt-btn-group">'
                                    +'<button class="pt-btn pt-btn-default" v-for="(drop,sub) in item.subdata" @click="onMemoryDropclick(drop,$event)" :id="drop.id" :fid="index" :optionid="sub"><span>{{drop.text}}</span></button>'
                                +'</div>'
                            +'</div>'
                        +'</div>',
