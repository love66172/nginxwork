	...
	commonFunc:{
		...
		btns:{
			...
			editorDialogShowByBtnHandler:function(data){
				//console.log(data);
				var ajaxBeforeData = data.ajaxBeforeHandler(data);//通过模板回调获取到模板的配置参数
			...
			initBtns:function(_btnComponents,_config){
				...
				for(var btnI in _btnComponents){
					...
					for(var btnJ=0; btnJ<btnFieldArray.length; btnJ++){
						var functionConfig = btnFieldArray[btnJ].functionConfig;
